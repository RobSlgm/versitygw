...
> [!WARNING]
> Starting with [version v1.4.0](https://github.com/versity/versitygw/releases/tag/v1.4.0) a [Helm chart](https://github.com/versity/versitygw/commit/af1a99c4dc6f7d0f2d9e748b17fd0489342ce170) is bundled with VersityGW. This repository is no longer maintained; please use the official chart included in the main project.
